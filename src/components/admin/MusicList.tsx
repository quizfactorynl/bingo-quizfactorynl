...
import { Flex, Center, Heading, TableContainer, Table, TableCaption, Thead, Tr, Th, Tbody, Td, Tfoot, Button, Icon, useDisclosure, useMediaQuery, useToast } from "@chakra-ui/react";
...
export default function MusicList ({
    ...
    return <Flex w={'100%'} p={isUnder600 ? '0.5rem' : '1rem'}>
        ...
        >
            ...
            <Center>
                <Heading fontSize={'xl'}>{bingo && bingo.title} Music List</Heading>
            </Center>
                            ...
                            return <Tr key = {i}>
                                ...
                                <Td>
                                    <Button color={'blackAlpha.800'} size={'sm'} 
                                        ...
                                        isLoading={loader.target_id === music._id && loader.loading}
                                    >
                                        <Icon as={EditIcon} className="inherit-parent-icon" />
                                    </Button>
                                    <Button size={'sm'} colorScheme="red" mx={1}
                                        onClick={()=> {
                                            setLoader({
        ...
        <ConfirmationModal 
            ...
            message={`Are you sure you want to delete '${deleteItem?.title || ''}' music?`}
            ...
            onYes={() => {
                ...
                axios.delete(`${API_ROUTES.MUSICS}/${deleteItem._id}`).then(res => {
